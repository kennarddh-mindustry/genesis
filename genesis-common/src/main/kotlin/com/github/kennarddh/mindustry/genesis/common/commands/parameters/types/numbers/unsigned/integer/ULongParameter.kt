package com.github.kennarddh.mindustry.genesis.common.commands.parameters.types.numbers.unsigned.integer
...
class ULongParameter : CommandParameter<ULong> {
    override fun parse(instance: KClass<ULong>, input: String): ULong {
        try {
