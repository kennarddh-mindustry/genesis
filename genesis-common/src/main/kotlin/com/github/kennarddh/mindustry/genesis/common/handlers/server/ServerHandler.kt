package com.github.kennarddh.mindustry.genesis.common.handlers.server
...
import com.github.kennarddh.mindustry.genesis.common.commands.parameters.validations.numbers.GTE
...
class ServerHandler : Handler() {
    ...
    fun host(mapName: String? = null, gameMode: Gamemode = Gamemode.survival): CommandResult {
        ...
        if (mapName != null) {
            ...
            com.github.kennarddh.mindustry.genesis.common.Logger.info("Randomized next map to be @.", map.plainName())
        }

        com.github.kennarddh.mindustry.genesis.common.Logger.info("Loading map...")
        ...
        try {
            Core.app.post {
                ...
                com.github.kennarddh.mindustry.genesis.common.Logger.info("Map loaded.")
    ...
    fun version(): CommandResult {
        return CommandResult(
            ...
            Genesis Common: ${mods.getMod(com.github.kennarddh.mindustry.genesis.common.GenesisCommon::class.java).meta.version}
            ...
            if (type == ConfigCommandType.get)
                ...
                try {
                    if (type == ConfigCommandType.remove) {
                        ...
                        config.set(
                            com.github.kennarddh.mindustry.genesis.common.commands.parameters.types.BooleanParameter()
